...
func Factory(ctx context.Context, conf *logical.BackendConfig) (logical.Backend, error) {
	...
	b.Backend = &framework.Backend{
		Help:        strings.TrimSpace(enigmaHelp),
...
const enigmaHelp = `
The Enigma backend is a Enigma emulator as a Vault secrets backend. It was presented in the context of an
Hashicorp Usergroup Meeting held in Montreal, January 2020.
`
